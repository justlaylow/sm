...
<body>
<div align="center">
	<h3 align="center">特力公司${maxMonth}月工资汇总表(应发)</h3>
	<table border="1" style="white-space: nowrap;">
		...
		<c:forEach var="should" items="${departmentShould }">
			<tbody>
				<tr>
	...
	<p align="center">
		...
		<button id="exportDepShould">导出</button>
...
<script type="text/javascript">
	...
	$('#exportDepShould').click(function(){
		window.location = "/sm/exportDepExcel";
	});
</script>
</body>
</html>